		...
		lualine_c = {
			{
				...
				icon = {
					'',
					color = { fg = c.bright_orange, gui = 'bold' },
				},
				separator = ' ',
			},
			{
			...
			},
			{
				...
				diff_color = {
					added = { fg = c.gray, gui = 'bold' },
					modified = { fg = c.gray, gui = 'bold' },
					removed = { fg = c.gray, gui = 'bold' },
				}
				-- icon = {
				-- ' ',
		...
		lualine_x = {
			{
				...
				diagnostics_color = {
					...
					warn = { fg = c.yellow, gui = 'bold' },
					info = { fg = c.bright_blue, gui = 'bold' },
					hint = { fg = c.neutral_blue, gui = 'bold' },
				},
				colored = true,
			},
		},
